...
func TestBuild(t *testing.T) {
	...
	var err error
	makedir := filepath.Join(goPath("GOPATH"), "src", "github.com/ie310mu/ie310go/forks/github.com", "derekparker", "delve")
...
func getDlvBin(t *testing.T) (string, string) {
	...
	out, err := exec.Command("go", "build", "-o", dlvbin, "github.com/ie310mu/ie310go/forks/github.com/derekparker/delve/cmd/dlv").CombinedOutput()
	if err != nil {
