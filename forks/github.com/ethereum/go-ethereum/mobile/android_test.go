...
import (
	...
	"github.com/ie310mu/ie310go/forks/github.com/ethereum/go-ethereum/internal/build"
)
...
//
// This method has been adapted from github.com/ie310mu/ie310go/forks/golang.org/x/mobile/bind/java/seq_test.go/runTest
func TestAndroid(t *testing.T) {
	...
	if _, err := exec.Command("which", "gomobile").CombinedOutput(); err != nil {
		...
		if out, err := exec.Command("go", "get", "github.com/ie310mu/ie310go/forks/golang.org/x/mobile/cmd/gomobile").CombinedOutput(); err != nil {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereum", "github.com/ie310mu/ie310go/forks/github.com/ethereum/go-ethereum/mobile")
