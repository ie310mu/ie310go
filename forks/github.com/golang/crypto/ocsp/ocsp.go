...
package ocsp // import "github.com/ie310mu/ie310go/forks/golang.org/x/crypto/ocsp"
...
func ParseResponseForCert(bytes []byte, cert, issuer *x509.Certificate) (*Response, error) {
	...
	if len(basicResp.Certificates) > 0 {
		...
		//
		// [1] https://github.com/ie310mu/ie310go/forks/github.com/golang/go/issues/21527
