...
func TestFrameFormat(t *testing.T) {
	var tests = []struct {
		...
		Frame(initpc),
		"%+s",
		"github.com/ie310mu/ie310go/forks/github.com/pkg/errors.init\n" +
...
func TestFuncname(t *testing.T) {
	tests := []struct {
		...
		{"", ""},
		{"runtime.main", "main"},
		{"github.com/ie310mu/ie310go/forks/github.com/pkg/errors.funcname", "funcname"},
		{"funcname", "funcname"},
...
func TestStackTrace(t *testing.T) {
	tests := []struct {
		...
		New("ooh"), []string{
			"github.com/ie310mu/ie310go/forks/github.com/pkg/errors.TestStackTrace\n" +
...
func TestStackTraceFormat(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"\n" +
			"github.com/ie310mu/ie310go/forks/github.com/pkg/errors.stackTrace\n" +
			"\t.+/github.com/pkg/errors/stack_test.go:207\n" +
			"github.com/ie310mu/ie310go/forks/github.com/pkg/errors.TestStackTraceFormat\n" +
