...
type TAttr struct {
	...
	Other1 string `xml:"http://github.com/ie310mu/ie310go/forks/golang.org/xml/ other,attr,omitempty"`
	Other2 string `xml:"http://github.com/ie310mu/ie310go/forks/golang.org/xmlfoo/ other,attr,omitempty"`
...
func TestMarshalNSAttr(t *testing.T) {
	...
	want := `<TableAttrs><TAttr xmlns:json_1="http://golang.org/2/json/" xmlns:json="http://golang.org/json/" xmlns:_xmlfoo="http://github.com/ie310mu/ie310go/forks/golang.org/xmlfoo/" xmlns:_xml="http://github.com/ie310mu/ie310go/forks/golang.org/xml/" xmlns:furniture="http://www.w3schools.com/furniture" xmlns:html4="http://www.w3.org/TR/html4/" html4:table="hello" furniture:table="world" xml:lang="en_US" _xml:other="other1" _xmlfoo:other="other2" json:other="other3" json_1:other="other4"></TAttr></TableAttrs>`
	str := string(data)
	if str != want {
		t.Errorf("Marshal:\nhave: %#q\nwant: %#q\n", str, want)
	}
