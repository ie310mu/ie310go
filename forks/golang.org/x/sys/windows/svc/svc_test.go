...
import (
	...
	"github.com/ie310mu/ie310go/forks/golang.org/x/sys/windows/svc/mgr"
)
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/ie310mu/ie310go/forks/golang.org/x/sys/windows/svc/example").CombinedOutput()
	if err != nil {
