...
The easiest way to install is to run `go get -u github.com/ie310mu/ie310go/forks/golang.org/x/text`. You can
also manually git clone the repository to `$GOPATH/src/github.com/ie310mu/ie310go/forks/golang.org/x/text`.
...
https://github.com/ie310mu/ie310go/forks/github.com/golang/go/issues. Prefix your issue with "x/text:" in the
