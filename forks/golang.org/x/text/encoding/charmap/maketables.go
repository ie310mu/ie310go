...
func main() {
	...
	printf("import (\n")
	printf("\t\"github.com/ie310mu/ie310go/forks/golang.org/x/text/encoding\"\n")
	printf("\t\"github.com/ie310mu/ie310go/forks/golang.org/x/text/encoding/internal/identifier\"\n")
	printf(")\n\n")
