...
const printerType = "github.com/ie310mu/ie310go/forks/golang.org/x/text/message.Printer"
...
func (r *rewriter) Visit(n ast.Node) ast.Visitor {
	...
	// "github.com/ie310mu/ie310go/forks/golang.org/x/text/message".Printer.
...
var rewriteFuncs = map[string]map[string]rewriteType{
	// TODO: Printer -> *github.com/ie310mu/ie310go/forks/golang.org/x/text/message.Printer
	"fmt": {
