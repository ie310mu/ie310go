...
Documentation on Gomock can be found [here](https://github.com/ie310mu/ie310go/forks/github.com/golang/mock).
...
To create a mock we’ll use [mockgen](https://github.com/ie310mu/ie310go/forks/github.com/golang/mock#running-mockgen).
From the directory ``` examples/helloworld/ ``` run ``` mockgen github.com/ie310mu/ie310go/forks/google.golang.org/grpc/examples/helloworld/helloworld GreeterClient > mock_helloworld/hw_mock.go ```
...
```Go
import "github.com/ie310mu/ie310go/forks/github.com/golang/mock/gomock"
import hwmock "github.com/ie310mu/ie310go/forks/google.golang.org/grpc/examples/helloworld/mock_helloworld"
```
...
Like before we'll use [mockgen](https://github.com/ie310mu/ie310go/forks/github.com/golang/mock#running-mockgen). From the `examples/route_guide` directory run:  `mockgen github.com/ie310mu/ie310go/forks/google.golang.org/grpc/examples/route_guide/routeguide RouteGuideClient,RouteGuide_RouteChatClient > mock_route_guide/rg_mock.go`
