...
```
$ go get -u github.com/ie310mu/ie310go/forks/google.golang.org/grpc/examples/helloworld/greeter_client
$ go get -u github.com/ie310mu/ie310go/forks/google.golang.org/grpc/examples/helloworld/greeter_server
```
...
1. Install the protoc Go plugin
   ...
   ```
   $ go get -u github.com/ie310mu/ie310go/forks/github.com/golang/protobuf/protoc-gen-go
   ```

1. Rebuild the generated Go code

   ```
   $ go generate github.com/ie310mu/ie310go/forks/google.golang.org/grpc/examples/helloworld/...
   ```
