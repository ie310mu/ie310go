...
[`UnaryClientInterceptor`](https://godoc.org/github.com/ie310mu/ie310go/forks/google.golang.org/grpc#UnaryClientInterceptor)
...
`DialOption`
[`WithUnaryInterceptor`](https://godoc.org/github.com/ie310mu/ie310go/forks/google.golang.org/grpc#WithUnaryInterceptor).

#### Stream Interceptor

[`StreamClientInterceptor`](https://godoc.org/github.com/ie310mu/ie310go/forks/google.golang.org/grpc#StreamClientInterceptor)
...
`DialOption`
[`WithStreamInterceptor`](https://godoc.org/github.com/ie310mu/ie310go/forks/google.golang.org/grpc#WithStreamInterceptor).
...
[`UnaryServerInterceptor`](https://godoc.org/github.com/ie310mu/ie310go/forks/google.golang.org/grpc#UnaryServerInterceptor)
...
`ServerOption`
[`UnaryInterceptor`](https://godoc.org/github.com/ie310mu/ie310go/forks/google.golang.org/grpc#UnaryInterceptor).

#### Stream Interceptor

[`StreamServerInterceptor`](https://godoc.org/github.com/ie310mu/ie310go/forks/google.golang.org/grpc#StreamServerInterceptor)
...
To install the unary interceptor for a Server, configure `NewServer` with
`ServerOption`
[`StreamInterceptor`](https://godoc.org/github.com/ie310mu/ie310go/forks/google.golang.org/grpc#StreamInterceptor).
